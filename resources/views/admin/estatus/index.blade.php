...
@section('content')
    ...
    <div class="row">
        <div class="col-md-6">
            <h6 class="text-white font-weight-bold mt-2">Listado de Estatus</h6>
        </div>
        <div class="col-md-6">
            <a href="{{route('admin.estatus.create')}}" class="btn btn-light btn-lg float-md-right" role="button" aria-pressed="true">Crear estatus</a>
        </div>
    </div>
