...
@section('content')
    ...
    <div class="row">
        <div class="col-md-6">
            <h6 class="text-white font-weight-bold mt-2">Bienvenido al listado de Subcategorias</h6>
        </div>
        <div class="col-md-6">
            <a href="{{route('subcategorias.create')}}" class="btn btn-light btn-lg float-md-right" role="button" aria-pressed="true">Crear Subcategoria</a>
        </div>
    </div>
        ...
        <table id="zero-config" class="table table-hover" style="width:100%">
            ...
            @foreach($subcategorias as $categoria)
                <tr>
                    ...
                    <td>
                        <a class="bs-tooltip" href="{{route('subcategorias.show', $categoria)}}" title="Mostrar"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#f0f0f0" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-eye">
