...
<html lang="en">
    <head>
        ...
        <link href="{{ asset('template/assets/css/authentication/form-1.css') }}" rel="stylesheet" type="text/css" />
        {{-- assets/css/authentication/form-1.css --}}
                    ...
                    <div class="form-form-wrap">
                        <div class="form-container">
                            <div class="form-content">
                                ...
                                <h1 class="">Log In to <a href="{{ route('login') }}"><span class="brand-name">CORK</span></a></h1>
                                ...
                                <form class="text-left">
                                    <div class="form">
                                        ...
                                        <div id="username-field" class="field-wrapper input">
                                            ...
                                            <input id="uid" name="uid" type="text" class="form-control" placeholder="Usuario">
                                        </div>
                                ...
                                <p class="terms-conditions">© 2019 All Rights Reserved. <a href="{{ route('home') }}">CORK</a> is a product of Designreset. <a href="javascript:void(0);">Cookie Preferences</a>, <a href="javascript:void(0);">Privacy</a>, and <a href="javascript:void(0);">Terms</a>.</p>
