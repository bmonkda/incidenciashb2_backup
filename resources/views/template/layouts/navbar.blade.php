                    ...
                    <a href="javascript:void(0);" class="nav-link dropdown-toggle user" id="user-profile-dropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <div class="media">
                            ...
                            <div class="media-body align-self-center">
                                ...
                                <h6><span>{{Auth::user()->desCargo()}}</span>
                            </div>
                        </div>
                        ...
                        <div class="">
                            @if ( Auth::user()->esAdmin() )
                                ...
                                <div class="dropdown-item">
                                    <a class="" href="{{route('admin.home')}}"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-user"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"></path><circle cx="12" cy="7" r="4"></circle></svg> Panel Administrador</a>
                                </div>
                            ...
                            <div class="dropdown-item">
                                ...
                                <form action="{{ route('logout') }}" method="post">
                                    @csrf    
                                    <a class="" onclick="this.closest('form').submit()">
