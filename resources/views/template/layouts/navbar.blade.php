                        ...
                        <div class="">
                            ...
                            <div class="dropdown-item">
                                ...
                                <form action="{{ route('logout') }}" method="post">
                                    @csrf    
                                    <a class="" href="{{ route('logout') }}" onclick="this.closest('form').submit()">
